...
#define MULTP2 0.85373472095314
    ...
    float4 CustomPostProcess(Varyings input) : SV_Target
    {
		...
		float r= LOAD_TEXTURE2D_X(_InputTexture, _PostProcessScreenSize.xy * newUVR).r ;
		float g = LOAD_TEXTURE2D_X(_InputTexture, _PostProcessScreenSize.xy * newUVG).g ;
		float b = LOAD_TEXTURE2D_X(_InputTexture, _PostProcessScreenSize.xy * newUVB).b ;
