...
namespace MK.EdgeDetection
{
    public static class KernelCollection
    {
        ...
        public static void Setkernels(MaterialPropertyBlock materialPropertyBlock, Material material, Precision precision, LargeKernel largeKernel, MediumKernel mediumKernel, SmallKernel smallKernel)
        {
